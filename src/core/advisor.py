...
class InvestmentAdvisor:
    ...
    def analyze(self, market_data, portfolio_data, macro_news, regime_info, historical_context="无历史记录。"):
        ...
        # [Phase 5 强化] Global Macro & Sentiment (全球宏观与避险逻辑)
        1. **跨市场映射**：分析港股/科技股/A股时，必须严格比对纳斯达克100(us.NDX)和标普500(us.INX)的涨跌。若美股暴跌，亚太科技股的上涨大概率是诱多。
        2. **避险情绪侦测**：若大盘下跌，而黄金(Gold)逆势大涨/触及布林带上轨，说明全球资金正在疯狂避险(Risk-Off)，此时必须降低风险资产的评级。
        3. **极端指标警报**：重点关注 KDJ 的 K 值。若 K > 80 (超买)，即使 MACD 金叉，也不建议追高；若 ATR 显著放大，意味着波动失控，需控制仓位。
